...
> 본 문서는 프로젝트의 **설계 SSoT**다. 설계 결정과 아키텍처를 다룬다.
> **작업 큐 / 진행 현황 / 블로커는 `STATUS.md` 참조** (이전 §11~§20).
> GuideLine §5의 산출물 #2(Technical Report)와 #3(Development Process Document)의 설계 초안 역할도 겸한다.
